    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_delegates', models.BooleanField(default=False, verbose_name='viewable to delegates')),
                ('show_partners', models.BooleanField(default=False, verbose_name='viewable to partners')),
                ...
                ('description', models.TextField(blank=True, help_text='i.e. Responsible for overseeing all logistical operations on the day of.', verbose_name='description')),
