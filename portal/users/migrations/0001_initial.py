# Generated by Django 2.1.2 on 2018-11-07 16:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activated', models.BooleanField(default=False, verbose_name='user has activated account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(blank=True, height_field=500, upload_to='', verbose_name='profile picture', width_field=500)),
                ...
                ('last_updated', models.DateTimeField(blank=True, null=True, verbose_name='last updated profile')),
            ],
        ),
        migrations.CreateModel(
            name='Partner',
            fields=[
                ...
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='partner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='unique identifier')),
                ('number', models.IntegerField(verbose_name='team number')),
            ],
        ),
        migrations.AddField(
            model_name='delegate',
        ...
        migrations.AddField(
            model_name='delegate',
            name='user',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='delegate', to=settings.AUTH_USER_MODEL),
        ),
    ]
