    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_type', models.SmallIntegerField(blank=True, choices=[(1, 'Gold Sponsor'), (2, 'Silver Sponsor'), (0, 'Finals Day'), (4, 'Prize Sponsor'), (3, 'Associate Sponsor'), (5, 'Swag Sponsor')], help_text='Leave blank if organization is not a partner. This is viewable to delegates if organization is a partner. As well, this will determine the ordering when partners listed.<br/>i.e. Title Partner', null=True, verbose_name='partner type')),
            ],
            options={
