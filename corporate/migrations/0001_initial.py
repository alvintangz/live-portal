    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_type', models.SmallIntegerField(blank=True, choices=[(3, 'Associate Sponsor'), (1, 'Gold Sponsor'), (5, 'Swag Sponsor'), (2, 'Silver Sponsor'), (4, 'Prize Sponsor'), (0, 'Finals Day')], help_text='Leave blank if organization is not a partner. This is viewable to delegates if organization is a partner. As well, this will determine the ordering when partners listed.<br/>i.e. Title Partner', null=True, verbose_name='partner type')),
            ],
            options={
